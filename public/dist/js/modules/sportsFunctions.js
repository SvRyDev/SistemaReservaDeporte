name_module_singular = "Deporte";
id_form = "#sportForm";
base_url_module = base_url + "/sports";
    ...
    columns: [
 ...
 
      {
        ...
        render: function (data, type, row) {
          return `
                            <button type="button" class="btn btn-warning text-white mdl-edit-btn btn-sm" data-id="${data.idTipoDeporte}" data-bs-toggle="modal" data-bs-target=""><span class="span_icon_edit">${icon_edit}</span><span class="d-none d-lg-inline">Editar</span></button>
                            <button type="button" class="btn btn-danger text-white mdl-delete-btn btn-sm" data-id="${data.idTipoDeporte}" >${icon_delete}<span class="d-none d-lg-inline">Eliminar</span></button>
                        `;
        },
      },
    ],
