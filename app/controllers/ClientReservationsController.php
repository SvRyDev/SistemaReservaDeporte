    ...
    function createReservation()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $idUserCliente = filter_input(INPUT_POST, 'idCliente', FILTER_VALIDATE_INT);
                ...
                $idCliente = $clientModel->getClientIdByUserId($idUserCliente);
                ...
                if ($reservationModel->isOverlappingReservation($idCampo, $fechaEntrada, $fechaSalida)) {
                    $data = [
                        ...
                        'states' => $statusModel->getAllStates(),
