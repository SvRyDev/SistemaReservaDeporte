            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/reservationStatus" aria-expanded="false"><i class="mdi mdi-check-circle-outline"></i><span class="hide-menu">Estado de Reserva</span></a>
                        </li>
                        <li class="sidebar-item">
