            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/roles" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Roles</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/sports" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Tipo Deportes</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/paymentMethods" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Metodos de Pago</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/sportEquipments" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Implementos Deportivos</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/sportsFields" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Campos Deportivos</span></a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/reservationStatus" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Estado de Reserva</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/payments" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Pagos</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/profile" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Perfil de Usuario</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo APP_URL; ?>/login/logout" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Cerrar Sesión</span></a>
                        </li>
