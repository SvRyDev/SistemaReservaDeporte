      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
            ...
            <p>Montalván se ha consolidado como un referente en la organización y gestión de eventos deportivos locales.</p>
          </div>
          <!-- Enlaces rápidos -->
          <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
    ...
    if ($data['module'] == 'accountClient') { ?>
      <script src="<?php dist(); ?>/js/modules/accountClientFunctions.js"></script>
    <?php };

    if ($data['module'] == "accountReserves") { ?>
      <script src="<?php dist(); ?>/js/modules/accountReservesFunctions.js"></script>
    <?php }; ?>



    <script src="<?= base_url() ?>/public/dist/js/validations/validations.js"></script>
